...
public class CustomGatewayFilter implements GatewayFilter,Ordered {
    ...
    private static final String INTERFACE_PREFIX_URL = "/dragon_api";
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        path = path.substring(INTERFACE_PREFIX_URL.length());
        log.info("请求路径：{}", path);
...
//        }
        ...
        if ("GET".equals(method)) {
            ...
            CustomGatewayFilter.RecorderServerHttpRequestDecorator requestDecorator = new RecorderServerHttpRequestDecorator(request);

...
import cn.felix.apiadmin.mapper.InterfaceInfoMapper;
...
import cn.felix.apicommon.model.vo.RequestParamsRemarkVO;
import cn.felix.apicommon.model.vo.ResponseParamsRemarkVO;
...
public class InterfaceInfoServiceImpl extends ServiceImpl<InterfaceInfoMapper, InterfaceInfo>
    ...
    public void validInterfaceInfo(InterfaceInfo interfaceInfo, boolean add) {
        ...
        // 创建时，参数不能为空
        if (add) {
            ThrowUtils.throwIf(StringUtils.isAnyBlank(name, description, url, host, method), ErrorCode.PARAMS_ERROR);
        }
        // 有参数则校验
    ...
    @Override
    public ApiClient getFelixApiClient(HttpServletRequest request) {
        // 获取当前登录用户
        User loginUser = userService.getLoginUser(request);

...
import cn.felix.apiadmin.mapper.UserMapper;
...
import cn.felix.apicommon.model.dto.user.UserQueryRequest;
import cn.felix.apicommon.model.entity.User;
import cn.felix.apicommon.model.enums.UserRoleEnum;
import cn.felix.apicommon.model.vo.LoginUserVO;
import cn.felix.apicommon.model.vo.UserVO;
...
import static cn.felix.apicommon.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     * 盐值，混淆密码
     */
    private static final String SALT = "felix";
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        synchronized (userAccount.intern()) {
            ...
            //默认头像
            user.setUserAvatar("https://lyzz.top/file/37007");
